...
class Texts_Common {
    ...
    static let statisticsAverageGlucose = {
        return NSLocalizedString("common_statistics_averageGlucose", tableName: filename, bundle: Bundle.main, value: "Average Glucose", comment: "statistics average glucose chart title")
    }()
    ...
    static let statisticsAverageCarbs = {
    ...
    static let statisticsTempBasalDelta = {
        return NSLocalizedString("common_statistics_tempBasalDelta", tableName: filename, bundle: Bundle.main, value: "Temp Basal Delta", comment: "statistics temp basal delta chart label")
    }()
